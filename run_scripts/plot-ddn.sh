...
python3 plot_traj.py --train_dir /scratch/forecasting/train/data/ --test True --test_dir /scratch/forecasting/val/data/ --network LSTMPredHeading --lr 0.0001 --end_epoch 50  --train_batch_size 20 --num_workers 20
echo "Done Training"
